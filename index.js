...
console.log("findMax(10, 9)", findMax(10, 9)); // Виведе: 10
console.log("findMax(12,12)", findMax(12, 12)); // Виведе: 12
console.log("findMax(9, 7)", findMax(9, 7)); // Виведе: 9
...
function getVariableType(variable) {
 ...
 "number" ? "Це число" :
        typeof variable ===
 "boolean" ? "Це булеве значення" : "Це інший тип";
